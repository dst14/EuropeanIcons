...
$TCA["user_europeanicons_icon"] = array (
        ...
        "interface" => array (
                "showRecordFieldList" => "hidden,name,image,author,year,place,country,linktocommons"
        ),
        ...
        "types" => array (
                "0" => array("showitem" => "hidden;;1;;1-1-1, name,image,author,year,place,country,linktocommons")
        ),
        "palettes" => array (
                "1" => array("showitem" => "")
        )
...
$TCA["user_europeanicons_occurences"] = array (
    ...
    "interface" => array (
        "showRecordFieldList" => "hidden,iconmm,title,authors,publisher,publishing_place,reprint,year,country,first_published,page,type_of_edit,type_of_repro,additional,geisignatur,linktolibrary,linktomore"
    ),
    ...
    "types" => array (
        "0" => array("showitem" => "hidden;;1;;1-1-1, iconmm,title,authors,publisher,publishing_place,reprint,year,country,first_published,page,type_of_edit,type_of_repro,additional,geisignatur,linktolibrary,linktomore")
    ),
    "palettes" => array (
        "1" => array("showitem" => "")
    )
